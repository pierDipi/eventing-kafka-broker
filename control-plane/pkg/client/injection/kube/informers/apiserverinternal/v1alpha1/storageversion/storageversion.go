...
func Get(ctx context.Context) v1alpha1.StorageVersionInformer {
	untyped := ctx.Value(Key{})
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch k8s.io/client-go/informers/apiserverinternal/v1alpha1.StorageVersionInformer from context.")
	}
