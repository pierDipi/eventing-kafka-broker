...
var _ appsv1.ControllerRevisionLister = (*wrapper)(nil)

func (w *wrapper) Informer() cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(nil, &apiappsv1.ControllerRevision{}, 0, nil)
}

func (w *wrapper) Lister() appsv1.ControllerRevisionLister {
	return w
}
