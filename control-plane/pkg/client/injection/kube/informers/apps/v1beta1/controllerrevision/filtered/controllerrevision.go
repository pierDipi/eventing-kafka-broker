...
func withInformer(ctx context.Context) (context.Context, []controller.Informer) {
	...
	for _, selector := range labelSelectors {
		...
		inf := f.Apps().V1beta1().ControllerRevisions()
...
func Get(ctx context.Context, selector string) v1beta1.ControllerRevisionInformer {
	untyped := ctx.Value(Key{Selector: selector})
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch k8s.io/client-go/informers/apps/v1beta1.ControllerRevisionInformer with selector %s from context.", selector)
	}
	return untyped.(v1beta1.ControllerRevisionInformer)
}
...
var _ appsv1beta1.ControllerRevisionLister = (*wrapper)(nil)

func (w *wrapper) Informer() cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(nil, &apiappsv1beta1.ControllerRevision{}, 0, nil)
}

func (w *wrapper) Lister() appsv1beta1.ControllerRevisionLister {
	return w
}
