...
func withInformer(ctx context.Context) (context.Context, []controller.Informer) {
	...
	for _, selector := range labelSelectors {
		...
		inf := f.Apps().V1beta1().Deployments()
...
func Get(ctx context.Context, selector string) v1beta1.DeploymentInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch k8s.io/client-go/informers/apps/v1beta1.DeploymentInformer with selector %s from context.", selector)
	}
...
var _ appsv1beta1.DeploymentLister = (*wrapper)(nil)

func (w *wrapper) Informer() cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(nil, &apiappsv1beta1.Deployment{}, 0, nil)
}

func (w *wrapper) Lister() appsv1beta1.DeploymentLister {
	return w
}
