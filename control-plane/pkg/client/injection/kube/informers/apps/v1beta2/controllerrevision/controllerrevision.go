...
func Get(ctx context.Context) v1beta2.ControllerRevisionInformer {
	untyped := ctx.Value(Key{})
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch k8s.io/client-go/informers/apps/v1beta2.ControllerRevisionInformer from context.")
	}
