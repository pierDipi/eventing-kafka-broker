...
func Get(ctx context.Context, selector string) v1beta2.ReplicaSetInformer {
	untyped := ctx.Value(Key{Selector: selector})
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch k8s.io/client-go/informers/apps/v1beta2.ReplicaSetInformer with selector %s from context.", selector)
	}
	return untyped.(v1beta2.ReplicaSetInformer)
}
...
var _ appsv1beta2.ReplicaSetLister = (*wrapper)(nil)

func (w *wrapper) Informer() cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(nil, &apiappsv1beta2.ReplicaSet{}, 0, nil)
}

func (w *wrapper) Lister() appsv1beta2.ReplicaSetLister {
	return w
}
