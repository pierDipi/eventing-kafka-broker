...
func Get(ctx context.Context) v1.CertificateSigningRequestInformer {
	untyped := ctx.Value(Key{})
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch k8s.io/client-go/informers/certificates/v1.CertificateSigningRequestInformer from context.")
	}
