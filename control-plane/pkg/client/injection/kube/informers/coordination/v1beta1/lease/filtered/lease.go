...
func withInformer(ctx context.Context) (context.Context, []controller.Informer) {
	...
	for _, selector := range labelSelectors {
		...
		inf := f.Coordination().V1beta1().Leases()
...
func Get(ctx context.Context, selector string) v1beta1.LeaseInformer {
	untyped := ctx.Value(Key{Selector: selector})
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch k8s.io/client-go/informers/coordination/v1beta1.LeaseInformer with selector %s from context.", selector)
	}
	return untyped.(v1beta1.LeaseInformer)
}
...
var _ coordinationv1beta1.LeaseLister = (*wrapper)(nil)

func (w *wrapper) Informer() cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(nil, &apicoordinationv1beta1.Lease{}, 0, nil)
}

func (w *wrapper) Lister() coordinationv1beta1.LeaseLister {
	return w
}
