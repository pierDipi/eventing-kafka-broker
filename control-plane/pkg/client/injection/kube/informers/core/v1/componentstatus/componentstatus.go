...
var _ corev1.ComponentStatusLister = (*wrapper)(nil)

func (w *wrapper) Informer() cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(nil, &apicorev1.ComponentStatus{}, 0, nil)
}

func (w *wrapper) Lister() corev1.ComponentStatusLister {
	return w
}
