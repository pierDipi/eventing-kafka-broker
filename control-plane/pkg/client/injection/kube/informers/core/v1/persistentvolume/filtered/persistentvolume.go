...
var _ corev1.PersistentVolumeLister = (*wrapper)(nil)

func (w *wrapper) Informer() cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(nil, &apicorev1.PersistentVolume{}, 0, nil)
}

func (w *wrapper) Lister() corev1.PersistentVolumeLister {
	return w
}
