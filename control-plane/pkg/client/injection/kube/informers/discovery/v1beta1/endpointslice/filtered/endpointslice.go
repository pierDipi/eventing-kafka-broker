...
func Get(ctx context.Context, selector string) v1beta1.EndpointSliceInformer {
	untyped := ctx.Value(Key{Selector: selector})
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch k8s.io/client-go/informers/discovery/v1beta1.EndpointSliceInformer with selector %s from context.", selector)
	}
