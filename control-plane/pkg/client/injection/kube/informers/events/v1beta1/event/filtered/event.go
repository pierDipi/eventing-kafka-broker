...
func Get(ctx context.Context, selector string) v1beta1.EventInformer {
	untyped := ctx.Value(Key{Selector: selector})
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch k8s.io/client-go/informers/events/v1beta1.EventInformer with selector %s from context.", selector)
	}
