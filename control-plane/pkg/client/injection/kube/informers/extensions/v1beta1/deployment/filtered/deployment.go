...
func withInformer(ctx context.Context) (context.Context, []controller.Informer) {
	...
	for _, selector := range labelSelectors {
		...
		inf := f.Extensions().V1beta1().Deployments()
...
func Get(ctx context.Context, selector string) v1beta1.DeploymentInformer {
	untyped := ctx.Value(Key{Selector: selector})
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch k8s.io/client-go/informers/extensions/v1beta1.DeploymentInformer with selector %s from context.", selector)
	}
	return untyped.(v1beta1.DeploymentInformer)
}
...
var _ extensionsv1beta1.DeploymentLister = (*wrapper)(nil)

func (w *wrapper) Informer() cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(nil, &apiextensionsv1beta1.Deployment{}, 0, nil)
}

func (w *wrapper) Lister() extensionsv1beta1.DeploymentLister {
	return w
}
