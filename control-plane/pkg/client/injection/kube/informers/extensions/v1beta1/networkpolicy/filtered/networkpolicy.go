...
func withInformer(ctx context.Context) (context.Context, []controller.Informer) {
	...
	for _, selector := range labelSelectors {
		...
		inf := f.Extensions().V1beta1().NetworkPolicies()
...
func Get(ctx context.Context, selector string) v1beta1.NetworkPolicyInformer {
	untyped := ctx.Value(Key{Selector: selector})
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch k8s.io/client-go/informers/extensions/v1beta1.NetworkPolicyInformer with selector %s from context.", selector)
	}
	return untyped.(v1beta1.NetworkPolicyInformer)
}
...
var _ extensionsv1beta1.NetworkPolicyLister = (*wrapper)(nil)

func (w *wrapper) Informer() cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(nil, &apiextensionsv1beta1.NetworkPolicy{}, 0, nil)
}

func (w *wrapper) Lister() extensionsv1beta1.NetworkPolicyLister {
	return w
}
