...
func Get(ctx context.Context) v1beta1.NetworkPolicyInformer {
	untyped := ctx.Value(Key{})
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch k8s.io/client-go/informers/extensions/v1beta1.NetworkPolicyInformer from context.")
	}
