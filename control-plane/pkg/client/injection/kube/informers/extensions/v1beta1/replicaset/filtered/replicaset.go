...
func Get(ctx context.Context, selector string) v1beta1.ReplicaSetInformer {
	untyped := ctx.Value(Key{Selector: selector})
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch k8s.io/client-go/informers/extensions/v1beta1.ReplicaSetInformer with selector %s from context.", selector)
	}
