...
func withInformer(ctx context.Context) (context.Context, []controller.Informer) {
	...
	for _, selector := range labelSelectors {
		...
		inf := f.Flowcontrol().V1alpha1().PriorityLevelConfigurations()
...
func Get(ctx context.Context, selector string) v1alpha1.PriorityLevelConfigurationInformer {
	untyped := ctx.Value(Key{Selector: selector})
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch k8s.io/client-go/informers/flowcontrol/v1alpha1.PriorityLevelConfigurationInformer with selector %s from context.", selector)
	}
	return untyped.(v1alpha1.PriorityLevelConfigurationInformer)
}
...
var _ flowcontrolv1alpha1.PriorityLevelConfigurationLister = (*wrapper)(nil)

func (w *wrapper) Informer() cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(nil, &apiflowcontrolv1alpha1.PriorityLevelConfiguration{}, 0, nil)
}

func (w *wrapper) Lister() flowcontrolv1alpha1.PriorityLevelConfigurationLister {
	return w
}
