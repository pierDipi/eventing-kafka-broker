...
func Get(ctx context.Context, selector string) v1beta1.FlowSchemaInformer {
	untyped := ctx.Value(Key{Selector: selector})
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch k8s.io/client-go/informers/flowcontrol/v1beta1.FlowSchemaInformer with selector %s from context.", selector)
	}
