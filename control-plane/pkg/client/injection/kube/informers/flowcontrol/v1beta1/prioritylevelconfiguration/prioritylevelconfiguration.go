...
func Get(ctx context.Context) v1beta1.PriorityLevelConfigurationInformer {
	untyped := ctx.Value(Key{})
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch k8s.io/client-go/informers/flowcontrol/v1beta1.PriorityLevelConfigurationInformer from context.")
	}
