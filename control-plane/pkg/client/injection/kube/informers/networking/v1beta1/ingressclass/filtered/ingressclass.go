...
func Get(ctx context.Context, selector string) v1beta1.IngressClassInformer {
	untyped := ctx.Value(Key{Selector: selector})
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch k8s.io/client-go/informers/networking/v1beta1.IngressClassInformer with selector %s from context.", selector)
	}
	return untyped.(v1beta1.IngressClassInformer)
}
...
var _ networkingv1beta1.IngressClassLister = (*wrapper)(nil)

func (w *wrapper) Informer() cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(nil, &apinetworkingv1beta1.IngressClass{}, 0, nil)
}

func (w *wrapper) Lister() networkingv1beta1.IngressClassLister {
	return w
}
