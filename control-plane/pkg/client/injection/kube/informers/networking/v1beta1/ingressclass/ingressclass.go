...
func Get(ctx context.Context) v1beta1.IngressClassInformer {
	untyped := ctx.Value(Key{})
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch k8s.io/client-go/informers/networking/v1beta1.IngressClassInformer from context.")
	}
