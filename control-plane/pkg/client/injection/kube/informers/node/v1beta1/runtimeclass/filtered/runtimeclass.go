...
func withInformer(ctx context.Context) (context.Context, []controller.Informer) {
	...
	for _, selector := range labelSelectors {
		...
		inf := f.Node().V1beta1().RuntimeClasses()
...
func Get(ctx context.Context, selector string) v1beta1.RuntimeClassInformer {
	untyped := ctx.Value(Key{Selector: selector})
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch k8s.io/client-go/informers/node/v1beta1.RuntimeClassInformer with selector %s from context.", selector)
	}
	return untyped.(v1beta1.RuntimeClassInformer)
}
...
var _ nodev1beta1.RuntimeClassLister = (*wrapper)(nil)

func (w *wrapper) Informer() cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(nil, &apinodev1beta1.RuntimeClass{}, 0, nil)
}

func (w *wrapper) Lister() nodev1beta1.RuntimeClassLister {
	return w
}
