...
func Get(ctx context.Context, selector string) v1alpha1.RoleBindingInformer {
	untyped := ctx.Value(Key{Selector: selector})
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch k8s.io/client-go/informers/rbac/v1alpha1.RoleBindingInformer with selector %s from context.", selector)
	}
