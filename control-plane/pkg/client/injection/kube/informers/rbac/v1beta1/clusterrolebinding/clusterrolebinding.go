...
func Get(ctx context.Context) v1beta1.ClusterRoleBindingInformer {
	untyped := ctx.Value(Key{})
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch k8s.io/client-go/informers/rbac/v1beta1.ClusterRoleBindingInformer from context.")
	}
