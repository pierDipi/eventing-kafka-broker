...
func withInformer(ctx context.Context) (context.Context, []controller.Informer) {
	...
	for _, selector := range labelSelectors {
		...
		inf := f.Rbac().V1beta1().ClusterRoleBindings()
...
func Get(ctx context.Context, selector string) v1beta1.ClusterRoleBindingInformer {
	untyped := ctx.Value(Key{Selector: selector})
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch k8s.io/client-go/informers/rbac/v1beta1.ClusterRoleBindingInformer with selector %s from context.", selector)
	}
	return untyped.(v1beta1.ClusterRoleBindingInformer)
}
...
var _ rbacv1beta1.ClusterRoleBindingLister = (*wrapper)(nil)

func (w *wrapper) Informer() cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(nil, &apirbacv1beta1.ClusterRoleBinding{}, 0, nil)
}

func (w *wrapper) Lister() rbacv1beta1.ClusterRoleBindingLister {
	return w
}
