...
func Get(ctx context.Context, selector string) v1beta1.RoleInformer {
	untyped := ctx.Value(Key{Selector: selector})
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch k8s.io/client-go/informers/rbac/v1beta1.RoleInformer with selector %s from context.", selector)
	}
	return untyped.(v1beta1.RoleInformer)
}
...
var _ rbacv1beta1.RoleLister = (*wrapper)(nil)

func (w *wrapper) Informer() cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(nil, &apirbacv1beta1.Role{}, 0, nil)
}

func (w *wrapper) Lister() rbacv1beta1.RoleLister {
	return w
}
