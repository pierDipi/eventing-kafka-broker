...
func withInformer(ctx context.Context) (context.Context, []controller.Informer) {
	...
	for _, selector := range labelSelectors {
		...
		inf := f.Rbac().V1beta1().RoleBindings()
...
func Get(ctx context.Context, selector string) v1beta1.RoleBindingInformer {
	untyped := ctx.Value(Key{Selector: selector})
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch k8s.io/client-go/informers/rbac/v1beta1.RoleBindingInformer with selector %s from context.", selector)
	}
	return untyped.(v1beta1.RoleBindingInformer)
}
...
var _ rbacv1beta1.RoleBindingLister = (*wrapper)(nil)

func (w *wrapper) Informer() cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(nil, &apirbacv1beta1.RoleBinding{}, 0, nil)
}

func (w *wrapper) Lister() rbacv1beta1.RoleBindingLister {
	return w
}
