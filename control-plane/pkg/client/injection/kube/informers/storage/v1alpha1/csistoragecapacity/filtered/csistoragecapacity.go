...
func Get(ctx context.Context, selector string) v1alpha1.CSIStorageCapacityInformer {
	untyped := ctx.Value(Key{Selector: selector})
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch k8s.io/client-go/informers/storage/v1alpha1.CSIStorageCapacityInformer with selector %s from context.", selector)
	}
