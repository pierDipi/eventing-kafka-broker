...
import (
	...
	pod "knative.dev/eventing-kafka-broker/control-plane/pkg/client/injection/kube/informers/core/v1/pod"
...
const (
	defaultControllerAgentName = "pod-controller"
	defaultFinalizerName       = "pods.core"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "core.Pod"),
	)
