...
public class ResourcesReconcilerBuilder {
  ...
  /**
   * Build the {@link ResourcesReconciler} and start listening for new contracts
   * using {@link ResourcesReconcilerMessageHandler}.
   *
  ...
  public ResourcesReconciler build() {
    return new ResourcesReconcilerImpl(ingressReconcilerListener,
                                       egressReconcilerListener);
  }
}
