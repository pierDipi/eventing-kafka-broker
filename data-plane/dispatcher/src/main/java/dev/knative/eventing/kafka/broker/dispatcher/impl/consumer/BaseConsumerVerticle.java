...
public abstract class BaseConsumerVerticle extends AbstractVerticle {
  public interface Initializer
    extends BiFunction<Vertx, BaseConsumerVerticle, Future<Void>> {}

  private static final Logger logger =
    LoggerFactory.getLogger(BaseConsumerVerticle.class);
  ...
  public BaseConsumerVerticle(final Initializer initializer,
                              final Set<String> topics) {
  ...
  public void stop(Promise<Void> stopPromise) {
    ...
    AsyncCloseable
      .compose(this.consumer::close, this.recordDispatcher, this.closeable)
      .close(stopPromise);
  }
