...
public class AllFilterTest {
  ...
  static Stream<Arguments> testCases() {
    return Stream.of(
      Arguments.of(
        event, new AllFilter(Set.of(new ExactFilter("id", "123-42"))), true),
      Arguments.of(
        event,
        new AllFilter(Set.of(new ExactFilter("id", "123-42"),
                             new ExactFilter("source", "/api/some-source"))),
        true),
      Arguments.of(
        event,
        new AllFilter(Set.of(new ExactFilter("id", "123"),
                             new ExactFilter("source", "/api/some-source"))),
        false),
      Arguments.of(
        event,
        new AllFilter(Set.of(new ExactFilter("id", "123-42"),
                             new ExactFilter("source", "/api/something-else"))),
        false),
