...
public class ConsumerVerticleFactoryImplMock
  extends ConsumerVerticleFactoryImpl {
  // trigger.id() -> Mock*er
  ...
  public ConsumerVerticleFactoryImplMock(final Properties consumerConfigs,
                                         final Properties producerConfigs) {
    super(consumerConfigs, new WebClientOptions(), producerConfigs,
  ...
  protected KafkaProducer<String, CloudEvent> createProducer(
    Vertx vertx, Map<String, Object> producerConfigs) {
    return KafkaProducer.create(
      vertx, new MockProducer<>(
               true, new StringSerializer(),
               (topic, data) -> new byte[0]  // No need to use the real one,
                                             // since it doesn't support headers
               ));
  }

  @Override
  protected KafkaConsumer<Object, CloudEvent> createConsumer(
    Vertx vertx, Map<String, Object> consumerConfigs) {
    final var consumer =
  ...
  public void setRecords(
    final List<ConsumerRecord<String, CloudEvent>> records) {
