...
public class ConsumerVerticleFactoryImplTest {
  ...
  public void shouldAlwaysSucceed() {
    ...
    consumerProperties.setProperty(KEY_DESERIALIZER_CLASS_CONFIG,
                                   StringDeserializer.class.getName());
    consumerProperties.setProperty(VALUE_DESERIALIZER_CLASS_CONFIG,
    ...
    final var verticleFactory = new ConsumerVerticleFactoryImpl(
      consumerProperties, new WebClientOptions(), producerConfigs,
      mock(AuthProvider.class), mock(MeterRegistry.class));
  ...
  public void linearBackoffPolicy() {
    final var policy = ConsumerVerticleFactoryImpl.computeRetryPolicy(
  ...
  public void getNoopResponseHandler() {
    ...
    final var r = ConsumerVerticleFactoryImpl.getNoopResponseHandlerOrDefault(
      egress, () -> {
