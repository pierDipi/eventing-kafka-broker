...
public class Main {
  ...
  public static void main(final String[] args) throws IOException {
    ...
    HttpServerOptions httpServerOptions =
      new HttpServerOptions(Configurations.readPropertiesAsJsonSync(
        env.getHttpServerConfigFilePath()));
    ...
    final Supplier<Verticle> receiverVerticleFactory =
      new ReceiverVerticleFactory(env, producerConfigs, Metrics.getRegistry(),
                                  httpServerOptions);
    DeploymentOptions deploymentOptions = new DeploymentOptions().setInstances(
