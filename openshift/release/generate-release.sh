...
resolve_resources control-plane/eventing-kafka-broker/config/100-broker $broker_cp_output_file "$image_prefix" "$tag"
resolve_resources control-plane/eventing-kafka-broker/config/100-sink $broker_cp_output_file "$image_prefix" "$tag"
resolve_resources control-plane/eventing-kafka-broker/config/100-source $broker_cp_output_file "$image_prefix" "$tag"
resolve_resources control-plane/eventing-kafka-broker/config/200-controller $broker_cp_output_file "$image_prefix" "$tag"
resolve_resources control-plane/eventing-kafka-broker/config/200-webhook $broker_cp_output_file "$image_prefix" "$tag"
