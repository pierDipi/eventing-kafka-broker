...
resolve_resources control-plane/config/ $broker_cp_output_file $image_prefix $tag

# The DP folder for Broker:
resolve_resources control-plane/config/sink cp_broker.yaml $image_prefix $tag
