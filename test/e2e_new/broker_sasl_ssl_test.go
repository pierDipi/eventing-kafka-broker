...
func TestBrokerAuthPlaintext(t *testing.T) {
	...
	env.Test(ctx, t, features.SetupBrokerAuthPlaintext())
}
...
func TestBrokerAuthSaslPlaintextScram512(t *testing.T) {
	...
	env.Test(ctx, t, features.SetupBrokerAuthSaslPlaintextScram512(ctx))
}
...
func TestBrokerNotReadyWithoutAuthSecret(t *testing.T) {
	...
	env.Test(ctx, t, features.BrokerNotReadyWithoutAuthSecret())
}
